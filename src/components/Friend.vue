...
<transition name="showRouter">
  <div class="g-wrap">
    <div class="g-header">
        ...
        <span>
          <button-tab>
            <button-tab-item selected>动态</button-tab-item>
            <button-tab-item button-tab-default-background-color="#de0404"><span class="vux-reddot-s">附近</span></button-tab-item>
          </button-tab>
        </span>
        <i class="iconfont">&#xe649;</i>
    </div>
...
<script>
import { ButtonTab, ButtonTabItem, TransferDom, Actionsheet, Group, XSwitch, Toast } from 'vux'
